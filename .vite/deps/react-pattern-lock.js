...
// node_modules/react-pattern-lock/lib-esm/components/PatternLock.js
...
function Ye(e2, t2, n2) {
  ...
  var A, C2 = new oe(n2, v2, o2 ? e2.componentStyle : void 0), I2 = C2.isStatic && 0 === c2.length, P2 = function(e3, t3) {
  ...
  return P2.displayName = p, (A = import_react.default.forwardRef(P2)).attrs = g2, A.componentStyle = C2, A.displayName = p, A.shouldForwardProp = N2, A.foldedComponentIds = o2 ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : S, A.styledComponentId = v2, A.target = o2 ? e2.target : e2, A.withComponent = function(e3) {
...
// node_modules/react-pattern-lock/lib-esm/components/Point.js
...
var Point = function(_a) {
  ...
  return React.createElement(
    "div",
    { className: "react-pattern-lock__point-wrapper" + (selected ? " selected" : ""), style: {
    ...
    React.createElement(
      "div",
      { className: "react-pattern-lock__point", style: {
...
// node_modules/react-pattern-lock/lib-esm/components/Connectors.js
var React2 = __toESM(require_react());

// node_modules/react-pattern-lock/lib-esm/utils.js
...
var getPoints = function(_a) {
  ...
  return Array.from({ length: Math.pow(size, 2) }).map(function(x2, i2) {
    return {
      x: sizePerItem * (i2 % size) + halfSizePerItem - halfSize,
      y: sizePerItem * Math.floor(i2 / size) + halfSizePerItem - halfSize
    };
  });
};
...
var getCollidedPointIndex = function(_a, points, pointActiveSize) {
  ...
  for (var i2 = 0; i2 < points.length; i2 += 1) {
    if (x2 > points[i2].x && x2 < points[i2].x + pointActiveSize && y2 > points[i2].y && y2 < points[i2].y + pointActiveSize)
      return i2;
  }
  return -1;
};
var getConnectorPoint = function(p, pointActiveSize, connectorThickness) {
  return {
...
var exclusiveRange = function(rawStart, stop) {
  ...
  return Array.from({ length: Math.abs(start - stop) }).map(function(_2, i2) {
...
var getPointsInTheMiddle = function(index1, index2, size) {
  ...
  if (y1 === y2) {
    ...
    return exclusiveRange(y1, y2).map(function(x3) {
      return x3 * size + x1;
    });
  } else if (deltaX === deltaY) {
    var m_1 = x1 < x2 ? 1 : -1;
    return exclusiveRange(y1, y2).map(function(x3, i2) {
      return x3 * size + x1 + (i2 + 1) * m_1;
    });
  }
  return [];
};
...
var Connectors = function(_a) {
  ...
  var _b = React2.useState(null), mouse = _b[0], setMouse = _b[1];
  React2.useEffect(function() {
    return setMouse(initialMousePosition);
  }, [initialMousePosition]);
  var _c = React2.useMemo(function() {
    return {
      setMousePosition: function(_a2) {
  ...
  var connectors = [];
  for (var i2 = 0; i2 < path.length - 1; i2 += 1) {
    var current = points[path[i2]];
    var next = points[path[i2 + 1]];
    connectors.push({
  ...
  return React2.createElement("div", { className: "react-pattern-lock__connector-wrapper" }, connectors.map(function(_a2, i3) {
    var from = _a2.from, to = _a2.to;
    return React2.createElement("div", { className: "react-pattern-lock__connector", key: i3, style: {
...
var PatternLock = function(_a) {
      ...
      if (allowOverlapping || path.indexOf(index) === -1) {
        if (allowJumping || !path.length) {
          ...
          if (allowOverlapping)
            ...
            onChange(__spreadArray(__spreadArray(__spreadArray([], path, true), pointsInTheMiddle.filter(function(point) {
              return path.indexOf(point) === -1;
            }), true), [index], false));
        }
      }
    }
  ...
  var onResize = function() {
    var _a2 = wrapperRef.current.getBoundingClientRect(), top = _a2.top, left = _a2.left;
    setPosition({ x: left + window.scrollX, y: top + window.scrollY });
    return [top, left];
  };
  var onHold = function(_a2) {
    var clientX = _a2.clientX, clientY = _a2.clientY;
    if (disabled)
      return;
    var _b2 = onResize(), top = _b2[0], left = _b2[1];
    setInitialMousePosition({ x: clientX - left, y: clientY - top });
    setIsMouseDown(true);
    checkCollision({ x: clientX, y: clientY });
  };
  var onTouch = function(_a2) {
    var touches = _a2.touches;
    if (disabled)
      return;
    var _b2 = onResize(), top = _b2[0], left = _b2[1];
  ...
  React3.useEffect(function() {
    if (!isMouseDown)
      return;
    var onMouseMove = function(_a2) {
      var clientX = _a2.clientX, clientY = _a2.clientY;
      return checkCollision({ x: clientX, y: clientY });
    };
    var onTouchMove = function(_a2) {
      var touches = _a2.touches;
  ...
  React3.useEffect(function() {
    return setHeight(wrapperRef.current.offsetWidth);
  });
  React3.useEffect(function() {
  ...
  return React3.createElement(
    React3.Fragment,
    null,
    React3.createElement(Styles, null),
    React3.createElement(
      "div",
      { className: (0, import_classnames.default)(["react-pattern-lock__pattern-wrapper", { error, success, disabled }, className]), style: __assign(__assign({}, style), { width, height }), onMouseDown: onHold, onTouchStart: onTouch, ref: wrapperRef },
      Array.from({ length: Math.pow(size, 2) }).map(function(_2, i2) {
        return React3.createElement(Point_default, { key: i2, index: i2, size, pointSize, pointActiveSize, pop: !noPop && isMouseDown && path[path.length - 1] === i2, selected: path.indexOf(i2) > -1 });
      }),
      !invisible && points.length && React3.createElement(Connectors_default, { initialMousePosition, wrapperPosition: position, path, points, pointActiveSize, connectorRoundedCorners, connectorThickness })
    )
  );
};
...
var PatternLock_default = PatternLock;
var templateObject_1;

// node_modules/react-pattern-lock/lib-esm/index.js
var lib_esm_default = PatternLock_default;
export {
  lib_esm_default as default
};
//# sourceMappingURL=react-pattern-lock.js.map
